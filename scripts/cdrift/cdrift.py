...
def main():
    ...
    # Declare key objects
    name = 'Concept Dataset'
    experiment_name = 'cdrift_experiment'
    compute_target = ComputeTarget(workspace=ws, name='cpu-cluster')
    local_data_folder = './datasets/cdrift_data/'
    target_def_blob_store_path = '/blob-cdrift-dataset/'
    ...
    register_best_model(
            ...
            model_name='ConceptDrift_Model',
            model_path='outputs/model.pkl',
            description='AutoML Concept Drift Model'
            )
